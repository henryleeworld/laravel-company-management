...
export default {
  ...
  data() {
    return {
      columns: [
        { title: 'cruds.role.fields.id', field: 'id', thComp: TranslatedHeader, sortable: true, colStyle: 'width: 50px;' },
        { title: 'cruds.role.fields.title', field: 'title', thComp: TranslatedHeader, sortable: true },
        {
