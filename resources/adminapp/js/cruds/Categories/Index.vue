...
export default {
  ...
  data() {
    return {
      columns: [
        { title: 'cruds.category.fields.id', field: 'id', thComp: TranslatedHeader, sortable: true, colStyle: 'width: 50px;' },
        { title: 'cruds.category.fields.name', field: 'name', thComp: TranslatedHeader, sortable: true },
        {
